...
contract TestGroup is DSTest {
    ...
    function setUp() public {
        ...
        group = Group(
            address(
                groupProxyFactory.createGroupWithManager(
                    address(this),
    ...
    function testSignHelper() public {
        ...
        assertEq(groupRouter.recoverSigner(_marketData, signature, GroupSigning.Scheme.Eip712), vm.addr(pvKey));
    ...
    function testGroupRouterCreateAndChallengeMarket() public {
        ...
        matchMarketStakeInfo(_group, defaultMarketIdentifier, address(this), user1, 2 * 10**18);
    }
    ...
    function getStakingIds(bytes32 marketIdentifier, address _of) internal pure returns (bytes32 sId0, bytes32 sId1) {
    ...
    function defaultCreateAndChallengeMarket(
        ...
        _groupRouter.createAndChallengeMarket(
            marketData,
            marketDataSignature,
    ...
    function matchMarketState(
        ...
        (uint64 cDonBufferEndsAt, uint64 cResolutionBufferEndsAt, uint64 cDonBuffer, uint64 cResolutionBuffer) = _group
            .marketStates(marketIdentifier);
    ...
    function matchMarketStakeInfo(
        ...
        (address cStaker0, address cStaker1, uint256 cLastAmountStaked) = _group.marketStakeInfo(marketIdentifier);
