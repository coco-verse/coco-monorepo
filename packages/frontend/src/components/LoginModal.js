...
import { Flex, Spacer, Heading, Modal, ModalOverlay, ModalContent, Image, Text } from '@chakra-ui/react';

import { selectLoginModalState, sUpdateLoginModalIsOpen } from '../redux/reducers';
...
function LoginModal() {
  ...
  return (
    ...
    >
      <ModalOverlay />
      <ModalContent paddingLeft={5} paddingRight={5} paddingTop={3} paddingBottom={8}>
        <Flex
          paddingLeft={2}
          paddingRight={2}
          paddingTop={2}
              ...
              onClick={async () => {
                if (window.ethereum) {
                  await window.ethereum.request({
                    ...
                    params: [
                      {
                        chainId: hexlify(configs.chainId),
                        ...
                        blockExplorerUrls: [configs.blocExplorerUri],
                      },
                    ],
                  });
                }
