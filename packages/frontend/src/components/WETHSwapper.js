import { Text, Flex, Heading, useToast, NumberInput, NumberInputField, HStack } from '@chakra-ui/react';
  ...
  return (
    <Flex flexDirection="column" padding={2} backgroundColor={COLORS.PRIMARY} borderRadius={8} marginBottom={4}>
      ...
      <PrimaryButton
        ...
        title="Swap"
      />
      <Text marginTop={1} fontSize={14}>{`Need test ETH? Try a faucet`}</Text>
      <Flex>
        <Text
