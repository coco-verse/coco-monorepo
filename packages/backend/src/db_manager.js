...
// Stake functions
export async function addUserStake(userAddress, groupAddress, marketIdentifier, donEscalationIndex, amount, outcome) {
...
export async function updateSubmissionToInitialised(marketIdentifier, challengeData, challengeDataSignature) {
  return models.Submission.updateMany(
    {
      marketIdentifier,
    },
